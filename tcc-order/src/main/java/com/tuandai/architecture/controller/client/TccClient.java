...
public interface TccClient {
    ...
    @RequestMapping(value = TCC_PATH , method = RequestMethod.POST, produces = {MediaType.APPLICATION_JSON_UTF8_VALUE}, consumes = {MediaType.APPLICATION_JSON_UTF8_VALUE})
    String tryTrans(@RequestBody PatchTransModel patchTransModel);

    @RequestMapping(value = TCC_PATH , method = RequestMethod.PUT, produces = {MediaType.APPLICATION_JSON_UTF8_VALUE}, consumes = {MediaType.APPLICATION_JSON_UTF8_VALUE})
    String confirmTrans(@RequestBody String transId);

    @RequestMapping(value = TCC_PATH , method = RequestMethod.DELETE, produces = {MediaType.APPLICATION_JSON_UTF8_VALUE}, consumes = {MediaType.APPLICATION_JSON_UTF8_VALUE})
